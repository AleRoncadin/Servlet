 ...
 */
@WebServlet("/cjsp")
public class cjsp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reset!=null) {
			...
			resetList=true;
		    response.sendRedirect("/newDemoServer/cjsp");
			...
			request.setAttribute("count", count);
			request.setAttribute("list", list);
			RequestDispatcher disp = request.getRequestDispatcher("/WEB-INF/cview.jsp");
